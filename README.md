...
```
bin/elasticsearch-plugin install pl.allegro.tech.elasticsearch.plugin:elasticsearch-analysis-morfologik:8.19.3
```
...
### Elasticsearch 8.x
- 8.17.x (8.17.0, 8.17.1, 8.17.2, 8.17.3, 8.17.4, 8.17.5, 8.19.3)
