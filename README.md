...
```
bin/elasticsearch-plugin install pl.allegro.tech.elasticsearch.plugin:elasticsearch-analysis-morfologik:9.2.2
```
...
- 8.18.x (8.18.0, 8.18.2, 8.18.3, 8.18.5, 8.18.8)
- 8.17.x (8.17.0, 8.17.1, 8.17.2, 8.17.3, 8.17.4, 8.17.5, 8.17.7, 8.17.8)
- 8.16.x (8.16.0, 8.16.1)
- 8.15.x (8.15.0, 8.15.1, 8.15.2, 8.15.3, 8.15.4, 8.15.5)
...
### Elasticsearch 7.x
- 7.17.x (7.17.0, 7.17.3, 7.17.4, 7.17.5, 7.17.6, 7.17.7, 7.17.8, 7.17.9, 7.17.10, 7.17.11, 7.17.14, 7.17.22, 7.17.26, 7.17.29)
